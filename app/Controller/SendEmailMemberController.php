...
class SendEmailMemberController extends Controller
{
   ...
   public function sendEmail($request,$response,$args){
    ...
    try {
        ...
        $email = Miembros::selectRaw('email')
        ...
        $message .= '<a target="_blank" rel="noopener noreferrer nofollow" href="http://www.gatosrugby.com.co/GRC/" style="text-align:center"><img width="50%" height="50%" src="'.$imagen.'"></a>';
        $message .= '</div>';
    ...
    return $response->withRedirect('/miembros');
